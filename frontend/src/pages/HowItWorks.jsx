  ...
  return (
    <div className="max-w-5xl mx-auto px-6 md:px-10 py-16">
      ...
      <div className="mt-16 space-y-12">
        {[
          ...
          <div key={t} className="grid grid-cols-12 gap-6 items-start">
            <div className="col-span-12 md:col-span-2 font-mono text-[#3B82F6]">{String(i + 1).padStart(2, "0")}</div>
            <div className="col-span-12 md:col-span-10">
              <div className="flex items-center gap-3">
                <I className="text-[#3B82F6]" size={20} />
      ...
      <div className="mt-20 flex flex-wrap gap-3">
        <Link to="/post" className="bg-[#3B82F6] text-black px-8 py-4 font-semibold hover:bg-[#60A5FA] inline-flex items-center gap-2">Post your first brief <ArrowRight size={16} /></Link>
